...
const Dashboard = () => {
  ...
  const recentTwoQuizzed = [...quizzes].sort((dateA, dateB)=>dateA.createdAt-dateB.createdAt).slice(0, 3);
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4, flex: 1 }}>
        ...
        {userRole === 'user' && (
          <>
            ...
            <UserRoleDashboard quizzes={recentTwoQuizzed} />
          </>
        )}
          ...
          <>
            <Typography variant="h5" sx={{ mt: 4, mb: 2, fontWeight: 600 }}>
              Available Quizzes
                              ...
                              <Box>
              Coming soon public quizzes . Check on dashboard
                          </Box>
